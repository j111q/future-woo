...
const PrototypeShippingProviderChoice =
	ShippingProviderChoice as unknown as PrototypeComponent;
const PrototypeShippingSetupFullPage =
	ShippingSetupFullPage as unknown as PrototypeComponent;
const PrototypeHub = Hub as unknown as PrototypeComponent;
const PrototypeZoneEditPanel = ZoneEditPanel as unknown as PrototypeComponent;
const PrototypeRenameModal = RenameModal as unknown as PrototypeComponent;
...
const rootElement = document.getElementById( 'wss-shipping-setup-root' );

if ( rootElement ) {
	document.body.classList.add( 'woocommerce-shipping-native-settings-page' );
	createRoot( rootElement ).render( <ShippingNativeInlineSetup /> );
}
