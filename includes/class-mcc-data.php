...
class MCC_Data {
	...
	public static function get_channels() {
		$channels = array(
			array(
				...
				'action_label'          => 'Manage',
				'featured'              => true,
				'supported_channel_ids' => array( 'google', 'meta', 'pinterest', 'tiktok', 'amazon', 'ebay', 'tumblr', 'pocket_casts' ),
			),
			array(
				'id'           => 'google',
	...
	public static function get_campaigns() {
		...
		return array(
			array(
				...
				'goal_type'  => 'revenue',
				'goal_value' => 50000,
				'channels'   => array( 'google', 'meta', 'pinterest' ),
			...
			array(
				'id'         => 4,
				'name'       => 'TikTok launch test',
				'status'     => 'active',
				'goal_type'  => 'acquisition',
				'goal_value' => null,
				'channels'   => array( 'tiktok' ),
				'dates'      => 'Ongoing',
				'sessions'   => 980,
				'sales'      => 3420,
				'roas'       => null,
			...
			array(
				...
				'goal_type'  => 'revenue',
				'goal_value' => 20000,
				'channels'   => array( 'google', 'meta', 'tiktok' ),
				'dates'      => 'Dec 2, 2026',
				'sessions'   => null,
				'sales'      => null,
				'roas'       => null,
	...
	public static function get_campaign_detail( $id ) {
		...
		$base['channel_perf'] = array(
			...
			array( 'channel' => 'pinterest', 'activities' => 1,      'sessions' => 980,  'sales' => 4210, 'roas' => 3.5, 'status' => 'Running' ),
			array( 'channel' => 'tiktok',    'activities' => 1,      'sessions' => 780,  'sales' => 2910, 'roas' => 2.7, 'status' => 'Learning' ),
		);

		$base['activity'] = array(
			array( 'tone' => 'success', 'title' => 'Pinterest catalog ad crossed 100 orders', 'when' => '2 hours ago' ),
			array( 'tone' => 'neutral', 'title' => 'TikTok · Launch test entered learning', 'when' => 'Today · 06:00' ),
